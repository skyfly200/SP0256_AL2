...
byte *phrase1[] = {hexapod, robot, pause5, Solid_State_Depot, boulder, hackerspace};
byte lengths1[] = {10, 5, 1, 15, 5, 9};
int words1 = 6;
byte *phrase2[] = {Modular, Robotics, MOSS, Cubelets};
byte lengths2[] = {6, 8, 5, 8};
int words2 = 4;
